namespace Yarn.Unity.Addons.SpeechBubbles.Example
{
    ...
    public sealed class SampleBubbleOptionInput : MonoBehaviour, SampleControls.IDialogueActions
    {
        ...
        {
            if (bubbleDialogueView == null)
            {
                Debug.LogError($"Can't select next option, because {nameof(bubbleDialogueView)} is null!", this);
                return;
            }
        ...
        public void OnPreviousOption(InputAction.CallbackContext context)
        {
            if (bubbleDialogueView == null)
            {
                Debug.LogError($"Can't select previous option, because {nameof(bubbleDialogueView)} is null!", this);
                return;
            }
        ...
        public void OnAdvanceDialogue(InputAction.CallbackContext context)
        {
            if (bubbleDialogueView == null)
            {
                Debug.LogError($"Can't advance dialogue, because {nameof(bubbleDialogueView)} is null!", this);
                return;
            }
