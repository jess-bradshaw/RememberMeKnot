...
namespace Yarn.Unity.Addons.SpeechBubbles.Example
{
    public class SidescrollerController : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            {
                var allRunners = FindObjectsByType<DialogueRunner>(FindObjectsSortMode.None);
        ...
        private void ApplyMovement(MovementInput input)
        {
            ...
            Vector2 collisionSize = (boxCollider != null) ? boxCollider.size : Vector2.one;

            // Retrieve all colliders we have intersected after velocity has been applied.
            Collider2D[] hits = Physics2D.OverlapBoxAll(transform.position, collisionSize, 0);
